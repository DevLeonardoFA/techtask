...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Techtask_3cd85f8fe8e631a86531_20230601140545_archive.zip';
        const ARCHIVE_SIZE       = '33579348';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '3cd85f8-01140545';
        const SECONDARY_PACKAGE_HASH = 'a6be2b1-01140545';
        const VERSION            = '1.5.4';
